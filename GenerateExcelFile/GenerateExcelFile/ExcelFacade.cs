    ...
    public class ExcelFacade
    {
            ...
            if (objects != null)
            {
                ...
                for (int col = 0; col < numCols; col++)
                {
                    ...
                    if (col == 1 || col == 0)
                    {
                        ...
                        HeaderCell c1 = new HeaderCell(headers[col].ToString(), headerNames[col], index, stylesPart.Stylesheet, System.Drawing.Color.Aqua, 12, true);
                        header.AppendChild(c1);
                        //cellIndex = "B";
                    }
                    else
                    {
                        HeaderCell c = new HeaderCell(headers[col].ToString(), headerNames[col], index, stylesPart.Stylesheet, System.Drawing.Color.Yellow, 12, true);
            ...
            System.Drawing.Color fillColor)
        {
            ...
            patternFill.PatternType = fillColor == 
                        System.Drawing.Color.Yellow ? PatternValues.None : PatternValues.DarkGray;
